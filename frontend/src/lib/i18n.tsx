...
const translations = {
  fr: {
    ...
    daysUnit: 'jours',
    medalCount: (n: number) => `${n} médaille${n > 1 ? 's' : ''}`,
    ...
    kofiDescription: 'Si Jupiter Tracker vous plaît, vous pouvez soutenir le projet !',
    ...
    onboardingMedalEquation: (n: number) => `${n} séances cette semaine = 1 médaille 🏅`,
  ...
  en: {
    ...
    daysUnit: 'days',
    medalCount: (n: number) => `${n} medal${n > 1 ? 's' : ''}`,
    ...
    kofiDescription: 'If you enjoy Jupiter Tracker, you can support the project!',
    ...
    onboardingMedalEquation: (n: number) => `${n} sessions this week = 1 medal 🏅`,
