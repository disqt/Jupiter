...
function SwimmingWorkoutForm() {
  ...
  const form = useWorkoutForm({
    ...
    defaultFields: { duration: '', laps: '', sessionType: '', _activeFields: '' },
  ...
  const hasFormData = form.fields.duration !== '' || form.fields.laps !== '';
  ...
  return (
    <WorkoutFormShell form={form} color="swimming" shadowColor="rgba(6,182,212,0.3)"
      ...
      <InspirationCard sportType="natation" accentColor="text-swimming" hasData={hasFormData} workoutId={form.workoutId} />
