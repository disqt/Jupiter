...
function RunningWorkoutForm() {
  ...
  const storageKey = workoutId ? `running-edit-${workoutId}` : `running-draft-${date}`;
  ...
  return (
    <div className="px-5 pb-36 lg:max-w-xl lg:mx-auto lg:pb-20">
      <WorkoutFormHeader
        emoji={customEmoji || WORKOUT_CONFIG.course.defaultEmoji}
        name={customName || t.runningWorkout}
      ...
      {(!workoutId || editing) && (
        <button onClick={handleSave} disabled={saving}
          className="w-full py-4 border-none rounded-card font-inherit text-[15px] font-semibold cursor-pointer mt-6 transition-all duration-200 active:scale-[0.98] bg-running text-white shadow-[0_4px_20px_rgba(52,211,153,0.3)] disabled:opacity-50 disabled:cursor-not-allowed tracking-wide">
