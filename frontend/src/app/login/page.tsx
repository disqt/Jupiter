    ...
    <div className="min-h-dvh flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-8">
        ...
        <div className="lg:hidden flex flex-col items-center mb-6">
          <AuthIllustration className="w-[220px] mb-2" label={sessionLabel} />
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-text-muted hover:text-text transition-colors duration-150 p-0.5"
                  tabIndex={-1}
                >
                  {showPassword ? (
